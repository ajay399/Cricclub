...
if(isset($_REQUEST['submit']))
{
	...
	$ins="insert into tournament(type,date,firstteam,secondteam,location,price) values('$type','$date','$firstteam','$secondteam','$matchlocation','$price')";
	$exe=$conn->query($ins);
	if($exe)
	...
	display:none;
            ...
            <section class="forms-section">
                ...
                <div class="outer-w3-agile mt-3">
                    <h4 class="tittle-w3-agileits mb-4">Create Tournament</h4>
                    <div class="row validform">
                        ...
                        <div class="col-md-8 order-md-1 validform2">
                            ...
                            <form  action="#" method="post" class="needs-validation" novalidate="">
                                    ...
                                    <input type="datetime-local" class="form-control" name="matchdate" required>
									<br><br>
...
<option value="SOUTH AFRICA">South Africa</option>
                                   ...
                                   <label for="email">Price(Rs.):
                                    ...
                                    <input type="text" class="form-control" maxlength="4" minlength="4" name="price" required>
									<br><br>
...
<option value="Eden Gardens : India(Kolkata)">Eden Gardens : India(Kolkata)</option>
                                ...
                                <hr class="mb-4">
                                <button class="btn btn-primary btn-lg btn-block error-w3l-btn"  name="submit" type="submit">Create Tournament</button>
                            </form>
                        </div>
                    </div>
                </div>
